...
urlpatterns = [
    ...
    # path("api/mobileOTPTest/",views.sendSMS)
    # path("api/getUserAddress/",views.get_userAddress)
    
    
    # SELLER API ROUTES
    
    path("api/seller/login/",views.SellerLoginView.as_view()),
    # path("api/seller/login/",views.SellerLoginApi),
    path("api/seller/register/",views.RegisterSeller.as_view()),
    path("api/seller/verifyOTP/",views.verifySellerOTP.as_view()),
    path("api/seller/forgotPassword/",views.forgotSellerPassword.as_view()), 
    path("api/seller/resetPassword/",views.resetSellerPassword.as_view()),
    path("api/seller/scheduleMail/",views.schedule_mail),
    # path('api/seller/product/', include(router.urls)),
